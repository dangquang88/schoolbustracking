...
public class ContactAdapter_Teacher extends RecyclerView.Adapter<ContactAdapter_Teacher.ViewHodler> {
    private Context context;
    private ArrayList<TeacherModel> arrayList;

    public ContactAdapter_Teacher(Context context, ArrayList<TeacherModel> arrayList) {
    ...
    public void onBindViewHolder(@NonNull ViewHodler holder, @SuppressLint("RecyclerView") int position) {
        ...
        TeacherModel userModels = arrayList.get(position);
